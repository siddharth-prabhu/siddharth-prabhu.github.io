...
intro: "4. This tutorial derives the reverse- and forward-mode sensitivities of hybrid dynamical systems. We will then implement a custom ODE solver in JAX that can handle events in parallel."
use_math: true
author_profile: true
toc: false
