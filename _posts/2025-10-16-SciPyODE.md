...
$$ \begin{equation} \lambda _N^T = \frac{d\Phi}{dx_N} \end{equation}$$
$$ \begin{equation} \lambda _{k}^T = \lambda _{k + 1}^T \frac{\partial F(x_k, p)}{\partial x_k}, \quad k = n - 1, \ldots \ 0  \end{equation}$$
